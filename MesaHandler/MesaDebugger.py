...
class MesaDebugger:
    ...
    def __init__(self, name='corr_lnd',
        ...
        fig = self.make_iter_plot(name, dir=dir,
                                  min_zone=1, max_zone=None)
    ...
    def plot_data(self, data_file, num_cols, num_rows,
                  min_zone=1, max_zone=None, title=None):
    ...
    def make_iter_plot(self, name, dir=join('.', 'plot_data', 'solve_logs'),
                       min_zone=1, max_zone=None):
